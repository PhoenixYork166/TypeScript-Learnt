...
let someValue1: undefined;

// However, a function is NOT allowed to be type 'undefined'
// This is Incorrect
const printUndefined1 = (num2: number): undefined => {
...
combineValues1 = add1; // passing in a func
...
console.log(`combineValues: ${combineValues1(8, 8)}`); //16
